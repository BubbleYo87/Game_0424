...
public class EnemyB : MonoBehaviour
{
    ...
    private Quaternion idleTargetRot;
        ...
        if (currentState == State.Idle)
        {
            ...
            if (!isIdleRotating)
            {
                ...
                if (idleLookTimer <= 0f)
                {
                    ...
                    // 對當前的 y 軸角度加上隨機偏移
                    float newY = transform.eulerAngles.y + yawOffset;
                    idleTargetRot = Quaternion.Euler(0f, newY, 0f);
